...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="label ml-0 max-w-0 overflow-hidden whitespace-nowrap font-light text-gold opacity-0 transition-all duration-500 ease-out group-hover:ml-3 group-hover:max-w-[9rem] group-hover:opacity-100">
        WhatsApp us
      </span>
    </a>
  );
